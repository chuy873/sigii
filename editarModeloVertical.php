						...
						<div class="tab-pane active" id="tab1">
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="hidden" name="tipo" value="vertical"> <select
							...
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label" for="precioPromedio">Precio
										promedio</label>
									<div class="controls">
										$ <input name="precioPromedio" id="precioPromedio"
											class="input-small" type="text"
											value="<?php echo $data2["precioPromedio"]?>"> <span
											class="help-inline"></span>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="precioMin">Precio
										m&iacute;nimo</label>
									<div class="controls">
										$ <input name="precioMin" id="precioMin" class="input-small"
											type="text" value="<?php echo $data2["precioMin"]?>"> <span
											class="help-inline"></span>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="precioMax">Precio
										m&aacute;ximo</label>
									<div class="controls">
										$ <input name="precioMax" id="precioMax" class="input-small"
											type="text" value="<?php echo $data2["precioMax"]?>"> <span
											class="help-inline"></span>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input name="aumentoXPiso" id="aumentoXPiso"
											class="input-small" type="text"
											value="<?php echo $data1["aumentoXPiso"]?>"> <span
											class="help-inline"></span>
									</div>
								</div>
								<div class="control-group">
