				...
				<div class="tab-content">
					...
					<div class="control-group">
                                ...
                                <legend>Informaci&oacute;n num&eacute;rica</legend> 
                                    ...
                                    <div class="controls">
                                      <input name="absorcion" id="absorcion" class="input-small" type="text" value="<?php echo $data2["absorcion"]?>">                                        <span class="help-inline"></span>
                                    </div>
                                </div>  
                                      <div class="control-group">
                                    <label class="control-label" for="precio">Precio</label>
                                    <div class="controls">
                                        $ <input name="precio" id="precio" class="input-small" type="text" value="<?php echo $data2["precio"]?>">                                        <span class="help-inline"></span>
                                    </div>
                                </div>                                                                
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                     ...
                                     <div class="control-group">
                                    <label class="control-label" for="precioTerreno">Precio m2 de terreno</label>
                                    <div class="controls">
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="creditoSobreEnganche" id="creditoSobreEnganche" class="input-small" type="text" value="<?php echo $data2["creditoSobreEnganche"]?>" > meses                                       <span class="help-inline"></span>
                                    </div>
                                </div>
                                </fieldset> 
                                </div>                                                                                              
                                 ...
                                 <legend>Im&aacute;genes de fachadas </legend>
                                  <div id="fachadas">
                                   <?php $imagenes = "SELECT * FROM imagenes WHERE modelo_idmodelo ='".$idModelo."' AND tipo = 'fachada'";
                                    ...
                                    <label class="control-label" for="fachada<?php echo $j?>">Im&aacute;gen de fachada <?php echo $j?></label>                                    
                                    <div class="controls">
                                      <img src="<?php echo $data7["path"]?>" id="<?php echo $data7["idimagenes"]?>">
                                       <input type="hidden" name="eliminaImagen<?php echo $data7["idimagenes"]?>" id="eliminaImagen<?php echo $data7["idimagenes"]?>">
                                        <a href="#" class="btn" onclick="EliminaImagen1(<?php echo $data7["idimagenes"]?>)"><i class="icon-remove-circle"></i>Eliminar</a>
                                        <span class="help-inline"></span>                                       
                                    </div>
                                </div>
                                <?php $j++;}?>
                                </div>
                                <input type='hidden' id="contFachadas" name="contFachadas" value="<?php echo $j?>">
