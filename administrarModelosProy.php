	...
	<div class="row">
		<div class="span10 offset2">
		  <form class="form-horizontal" action="#" method="post">
		      <fieldset>
		        <legend><i class="icon-fullscreen"></i> Administrar modelos de <?php echo $data1["nombre"]?></legend>
		        <table class="table">
		        	<tr>
					...
					while ($data = mysql_fetch_array($dataModelo, MYSQL_ASSOC)) {
							...
							<tr>							  		
							  	...
							  	<a href="editarModeloHorizontal.php?id=<?php echo $data["idmodelo"]?>" class="btn btn-primary"><i class="icon-edit icon-white"></i> Editar</a>
							  		...
							  		<a href="editarModeloVertical.php?id=<?php echo $data["idmodelo"]?>" class="btn btn-primary"><i class="icon-edit icon-white"></i> Editar</a>
							  	<?php }?>
							  		</td>
							  		<td> 
		        ...
		        <?php if($data1["tipo"]=="horizontal"){?>
		           <a href="registrarModeloHorizontal.php" class="btn btn-inverse"><i class="icon-plus-sign icon-white"></i> Agregar modelo horizontal...</a>
		           <?php } 
		            if($data1["tipo"]=="vertical"){
		            ?>
		              <a href="registrarModeloVertical.php" class="btn btn-inverse"><i class="icon-plus-sign icon-white"></i> Agregar modelo vertical...</a>
		          <?php }?>
		         <a href="seleccionarProyAdmin.php" class="btn"><i class="icon-remove-circle"></i> Regresar</a>		          
		        </div>
		      </fieldset>
			</form>
		</div>
