			...
			<div class="tabbable">
				...
				<div class="tab-content">
                               ...
                               <input name="fechaRevision"  type="text" class="span2" value="<?php date_default_timezone_set('America/Mexico_City'); echo date('Y-m-d'); ?>" id="dp2" >
                                ...
                                <div class="control-group">
                                  ...
                                  <select class="span2" name='segmento' id='segmento'>
                                   <option value="" selected=selected disabled=disabled>Selecciona el segmento</option>
                                ...
                                <legend>Informaci&oacute;n num&eacute;rica</legend>    
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="unidadesEtapa" id="unidadesEtapa" class="input-small" type="text">
                                        <span class="help-inline"></span>
                                    </div>
                                </div> 
                                 <div class="control-group">
					...
					<fieldset>
                                 ...
                                 while($k<=4){?>
                                 <div class="control-group">
                                    <label class="control-label" for="imagenAmenidad<?php echo $k?>">Im&aacute;gen de amenidad 
                                    <?php echo $k?></label>                                    
                                    <div class="controls">
