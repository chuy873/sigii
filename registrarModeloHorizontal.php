					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab1">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="hidden" name="tipo" value="horizontal"> <select
											class="span2" name='proyecto' id='proyecto'>
							...
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label" for="precioTerreno">Precio m2 del
										terreno</label>
									<div class="controls">
								...
								<div class="control-group">
									<label class="control-label" for="anchoTerreno">Frente del
										terreno</label>
									<div class="controls">
										<input name="anchoTerreno" id="anchoTerreno"
											class="input-small" type="text"> <span class="help-inline"></span>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="largoTerreno">Largo del
										terreno</label>
									<div class="controls">
										<input name="largoTerreno" id="largoTerreno"
											class="input-small" type="text"> <span class="help-inline"></span>
									</div>
								</div>
								<div class="control-group">
						...
						<div class="tab-pane" id="tab3">
							...
							<fieldset>
								...
								<a class="btn addDist" onclick="createDivDistribuciones()"><i
									class="icon-plus-sign"></i>Agregar otra</a>
							</fieldset>
							<fieldset>
								<legend>Im&aacute;genes de fachadas </legend>
								<div class="control-group" id="fachadas">
									<input type='hidden' id="contFachadas" name="contFachadas"> <label
										class="control-label" for="fachada1">Im&aacute;gen de fachada
										1</label>
									<div class="controls">
										<input name="fachada1" id="fachada1"
											class="input-medium inputFachada" type="file"> <span
											class="help-inline"></span>
										<div id="errorfachada1"></div>
									</div>
								</div>
								<a class="btn" onclick="createDivFachadas()"><i
									class="icon-plus-sign"></i>Agregar otra</a>
							</fieldset>
					...
					<div class="tabbable tabs-below">
						...
						<div class="form-actions">
							...
							<button type="submit" class="btn btn-primary"
								onclick="agregarOtro()">Registrar y agregar otro modelo...</button>
