...
<div class="row">
	<div class="span6 offset4">
		<form class="form-horizontal" action="#" method="post">
			<fieldset>
				<legend>
					<i class="icon-star"></i>Administrar caracter&iacute;sticas
				</legend>
				<table class="table">
					<tr>
					...
					<tr>
						...
						<td><a href="#modalEdit" data-toggle="modal"
							class="openEditCaract btn btn-primary"
							data-id="<?php echo $data["idcaracteristicas"]?>"
							data-nombre="<?php echo $data["nombre"]?>"><i
								class="icon-edit icon-white"></i> Editar</a>
						</td>
						<td><a href="#modalDelete" data-toggle="modal"
							class="openDeleteCaract btn btn-danger"
							data-id="<?php echo $data["idcaracteristicas"]?>"><i
								class="icon-trash icon-white"></i> Eliminar</a>
						</td>
						<td><input type="hidden"
							value='<?php echo  $data["idcaracteristicas"]?>'
							name="idAmenidad_<?php echo $data["idcaracteristicas"]?>" /></td>
					</tr>
				...
				<div class="form-actions">
					<a href="#" class="confirm-add btn btn-inverse"><i
						class="icon-plus-sign icon-white"></i> Agregar
						caracter&iacute;stica...</a> <a href="bienvenido.php" class="btn">Regresar</a>
				</div>
			</fieldset>
		</form>
	</div>
...
<div id="modalEditar" class="modal hide fade in">
	...
	<div class="modal-body">
		<label class="control-label" for="caracteristica">Nombre</label> <input
			type="text" class="input-medium" id="editarcaracteristicas"> <input
			type="hidden" id="idcaracteristicas">

	</div>
	<div class="modal-footer">
		<a href="#" class="btn btn-primary"
			onclick="editar('caracteristicas')">Editar</a> <a href="#"
			class="btn secondary" data-dismiss="modal">Cancelar</a>
	</div>
</div>
<div id="modalBorrar" class="modal hide fade in">
	...
	<div class="modal-body">
		<p>Atenci&oacute;n! Est&aacute;s a punto de eliminar la
	...
	<div class="modal-footer">
		<a href="#" class="btn btn-danger"
			onclick="eliminar('caracteristicas')">Eliminar</a> <a href="#"
			class="btn secondary" data-dismiss="modal">Cancelar</a>
	</div>
</div>
<div id="modal4" class="modal hide fade in">
	...
	<div class="modal-body">
		<label class="control-label" for="caracteristicas">Nombre</label> <input
			type="text" class="input-small" id="nombrecaracteristicas">

	</div>
	<div class="modal-footer">
		<a href="#" class="btn btn-primary"
			onclick="insertar('caracteristicas')">Agregar</a> <a href="#"
			class="btn secondary" data-dismiss="modal">Cancelar</a>
	</div>
</div>
