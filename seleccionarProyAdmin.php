...
<div class="row">
	<div class="span6 offset4">
		<form class="form-horizontal" action="administrarModelosProy.php"
			method="post">
			<fieldset>
				<legend>
					<i class="icon-fullscreen"></i> Administrar modelos
				</legend>
		...
		<form class="form-horizontal" action="administrarModelosProy.php"
			...
			<fieldset>
				<legend>
					<i class="icon-resize-horizontal"></i> Administrar modelos
					horizontales
				</legend>
				<div class="control-group">
					<label class="control-label" for="selectProy">Proyecto horizontal:
					</label>
					<div class="controls">
		...
		<form class="form-horizontal" action="administrarModelosProy.php"
			...
			<fieldset>
				<legend>
					<i class="icon-resize-vertical"></i> Administrar modelos verticales
				</legend>
				<div class="control-group">
