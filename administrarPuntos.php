...
<div class="row">
	<div class="span6 offset4">
		<form class="form-horizontal" action="#" method="post">
			<fieldset>
				<legend>
					<i class="icon-screenshot"></i>Administrar puntos de afluencia
				</legend>
				<table class="table">
					<tr>
					...
					<tr>
						...
						<td><a href="#modalEdit" data-toggle="modal"
							class="openEditPuntos btn btn-primary"
							data-id="<?php echo $data["idpuntosAfluencia"]?>"><i
								class="icon-edit icon-white"></i> Editar</a>
						</td>
						<td><a href="#modalDelete" data-toggle="modal"
							class="openDeletePuntos btn btn-danger"
							data-id="<?php echo $data["idpuntosAfluencia"]?>"><i
				...
				<div class="form-actions">
					<a href="#" class="confirm-add btn btn-inverse"><i
						class="icon-plus-sign icon-white"></i> Agregar punto de
						afluencia...</a> <a href="bienvenido.php" class="btn">Regresar</a>
				</div>
			</fieldset>
		</form>
	</div>
	...
	<form action="control/admonPuntos.php" method="post"
		...
		<div class="modal-body">
			<input type="hidden" name="accion" value="editar"> <input
				type="hidden" name="idpuntosAfluencia" id="idpuntosAfluencia"> <label
				class="control-label">Nombre</label> <input type="text"
				class="input-small" name="nombrePunto" id="nombrePunto"> <label
				class="control-label">Clasificaci&oacute;n</label> <select
				class="span2" name='tipoPunto' id="tipoPunto">
				<option value="Hospitales">Hospitales</option>
				<option value="Centros comerciales">Centros comerciales</option>
				<option value="Otro">Otro</option>
			</select> <label class="control-label">Logo</label> <img
				id="logoPunto"> <label class="control-label">Cambiar:</label> <input
	...
	<form action="control/admonPuntos.php" method="post">
		...
		<div class="modal-body">
			<input type="hidden" name="accion" value="eliminar"> <input
				type="hidden" name="idpuntosAfluencia" id="idpuntosAfluenciaD">
			<p>Atenci&oacute;n! Est&aacute;s a punto de eliminar el punto de
				afluencia.</p>
...
<div id="modal4" class="modal hide fade in">
	<form action="control/admonPuntos.php" method="post"
		...
		<div class="modal-body">
			<input type="hidden" name="accion" value="insertar"> <label
				class="control-label">Nombre</label> <input type="text"
				class="input-small" name="nombrePunto"> <label class="control-label">Clasificaci&oacute;n</label>
			<select class="span2" name='tipoPunto' id="tipoPunto">
				<option value="Hospitales">Hospitales</option>
				<option value="Centros comerciales">Centros comerciales</option>
				<option value="Otro">Otro</option>
			</select> <label class="control-label">Logo</label> <input
				type="file" id="file" name="file">
		</div>
		<div class="modal-footer">
