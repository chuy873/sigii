	...
	<div class="tabbable tabs-left">
		...
		<ul class="nav nav-tabs">
			<li class="active"><a href="#tab1" data-toggle="tab"><img
					src="assets/img/black-spot.png" /> Horizontales</a></li>
			<li><a href="#tab2" data-toggle="tab"><img
					src="assets/img/black-spot.png" /> Verticales</a></li>
			<br />
			<br />
			<br />
			<li><a href="javascript:window.print()">Imprimir esta página <img
				...
				<td>
					<div class="tab-content">
								...
								<div class="span8 offset3">
									...
									<table class="table table-bordered">
										...
										<tr>
											...
											<td><?php echo ($data["unidadesTotales"]-$data["unidadesVendidas"])?>
											</td>
											<td><?php if($data["tiempoMercado"]!=0){
												echo round($data["unidadesVendidas"]/$data["tiempoMercado"],2);
											}?>
											</td>
											<td><?php echo round($dataM2["promM2"], 0, PHP_ROUND_HALF_UP);?>
											</td>
											<td><?php echo round($dataM2Terr["promM2Terr"], 0, PHP_ROUND_HALF_UP);?>
											</td>
											<td>$<?php if(round($dataM2["promM2"], PHP_ROUND_HALF_UP)!=0){
											...
											<td colspan="2">
												<table class="table">
													<tr>
														...
														<td>$<?php  echo round($dataSepyEng["separacion"],2);?>
														</td>
													</tr>
													<tr>
														<th>Monto de enchanche min(%)</th>
														<td><?php  echo round($dataSepyEng["engancheMin"],0);?>%</td>
													</tr>
													<tr>
														<th>Monto en cantidad</th>
														<td>$<?php  echo number_format(round(($dataprecioYcredito["precio"]*($dataSepyEng["engancheMin"]/100)),2), 2, '.', ',');?>
														</td>
													</tr>
													<tr>
														<th>Credito sobre enganche</th>
														<td><?php echo round($dataprecioYcredito["credito"],0)?>
															meses</td>
													</tr>
												</table>
											</td>
					 ...
					 if($dataPromCaract["nombre"]=="Baños"){?>
													...
													<tr>
														<th>Llamadas de seguimiento</th>
														<td><?php  echo $data["llamadasSeguimiento"];?></td>
													</tr>
												</table>
											</td>
											<td colspan="4">
												<table class="table">
													...
													<tr>
														...
														<td>$<?php echo number_format(($dataM2Terr["promM2Terr"]*$dataM2Terr["precioM2Terr"]), 2, '.', ',');?>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><?php echo  number_format(($data["unidadesVendidas"]/$data["unidadesTotales"]), 3, '.', '');?>
														</td>
													</tr>
												</table>
											</td>
								...
								<div class="span8 offset3">
									...
									<table class="table table-bordered">
										...
										<tr>
											...
											<td><?php echo round($data["unidadesVendidas"]/$data["tiempoMercado"],2)?>
											</td>
											<td><?php echo round($dataM2["promM2"], 0, PHP_ROUND_HALF_UP);?>
											</td>
											<td>$<?php if($dataM2["promM2"]!=0){
												echo number_format(round(($dataprecioYcredito["precio"]/round($dataM2["promM2"], 0, PHP_ROUND_HALF_UP)),2), 2, '.', ',');
											}?>
											</td>
										</tr>
											...
											<td colspan="4">
												<table class="table">
													<tr>
														...
														<td>$<?php echo number_format($dataPrecios["precioPromedio"], 2, '.', ',');?>
														</td>
													</tr>
													<tr>
														<th>Precio m&iacute;nimo</th>
														<td>$<?php echo number_format(($dataPrecios["precioMin"]), 2, '.', ',');?>
														</td>
													</tr>
													<tr>
														<th>Precio m&aacute;ximo</th>
														<td>$<?php echo number_format(($dataPrecios["precioMax"]), 2, '.', ',');?>
														</td>
													</tr>
													<tr>
														<th>Fecha de inicio</th>
