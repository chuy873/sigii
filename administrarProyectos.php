...
<div class="row">
	<div class="span10 offset2">
		<form class="form-horizontal" action="#" method="post">
			<fieldset>
				<legend>
					<i class="icon-briefcase"></i> Administrar proyectos
				</legend>
				<table class="table">
					<tr>
						...
						<th style='text-align: left; width: 70px; padding: 5px;'>Unidades
							Vendidas</th>
					...
					<tr>
						...
						<td><?php if($data["tipo"]=="horizontal"){?> <a
							href="editarProyectoHorizontal.php?idproyecto=<?php echo $data["idproyecto"]?>"
							class="btn btn-primary"><i class="icon-edit icon-white"></i>
								Editar</a> <?php }else if($data["tipo"]=="vertical"){?> <a
							href="editarProyectoVertical.php?idproyecto=<?php echo $data["idproyecto"]?>"
							class="btn btn-primary"><i class="icon-edit icon-white"></i>
								Editar</a> <?php }?>
						</td>
						<td><a
							href="earth.php?idproyecto=<?php echo $data["idproyecto"]?>&nombre=<?php echo $data["nombre"]?>"
							class="btn "><i class="icon-globe"></i>Posicionar</a>
						</td>
						<td><a
							href="actualizarProyecto.php?idproyecto=<?php echo $data["idproyecto"]?>"
							class="btn btn-info"><i class="icon-refresh icon-white"></i>
								Actualizar</a>
						</td>
						<?php if($usuariologueado->getTipo()=="administrador"){?>
						<td><a href="#" class="openDeleteProyecto btn btn-danger"
							data-id="<?php echo $data["idproyecto"]?>"><i
				...
				<div class="form-actions">
					<a href="registrarProyectoVertical.php" class="btn btn-inverse"><i
						class="icon-plus-sign icon-white"></i> Agregar proyecto
						vertical...</a> <a href="registrarProyectoHorizontal.php"
						class="btn btn-inverse"><i class="icon-plus-sign icon-white"></i>
						Agregar proyecto horizontal...</a> <a href="bienvenido.php"
						class="btn"><i class="icon-remove-circle"></i> Regresar</a>
				</div>
			</fieldset>
		</form>
	</div>
