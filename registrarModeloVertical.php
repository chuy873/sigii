<?php
/* Pagina Registrar modelo de proyecto vertical
				...
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab1">
							...
							<fieldset>
								...
								<div class="control-group" id="precios">
									<input type='hidden' name="contPrecios" id="contPrecios" /> <label
										class="control-label" for="precio1">Precio 1</label>
									<div class="controls">
										$ <input name="precios1" id="precios1" class="input-medium"
											type="text"> <span class="help-inline"></span>
									</div>
									</br>
								</div>
								<a class="btn" onclick="createDivPrecio()"><i
									class="icon-plus-sign"></i>Agregar otro</a>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input name="unidades" id="unidades" class="input-small"
											type="text"> <span class="help-inline"></span>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									<label class="control-label" for="aumentoXPiso">Aumento por
										piso</label>
									<div class="controls">
										<input name="aumentoXPiso" id="aumentoXPiso"
											class="input-small" type="text"> <span class="help-inline"></span>
									</div>
								</div>
								<div class="control-group">
						...
						<div class="tab-pane" id="tab3">
							...
							<fieldset>
								...
								<input type="hidden" id="contDist" name="contDist" value="1"> <a
									class="btn" onclick="createDivDistribuciones()"><i
					...
					<div class="tabbable tabs-below">
						...
						<div class="form-actions">
							...
							<button class="btn btn-primary" onclick="agregarOtro()">Registrar
