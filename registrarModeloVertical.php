				...
				<div class="tab-content">
					...
					<div class="control-group">
                                ...
                                <legend>Informaci&oacute;n num&eacute;rica</legend> 
                                   ...
                                   <input type='hidden' name="contPrecios" id="contPrecios"/>
                                    <label class="control-label" for="precio1">Precio 1</label>                                    
                                    <div class="controls">
                                        $ <input name="precios1" id="precios1" class="input-medium" type="text">
                                        <span class="help-inline"></span>                                       
                                    </div>
                                    </br>
                                </div>
                                <a class="btn" onclick="createDivPrecio()"><i class="icon-plus-sign"></i>Agregar otro</a>                                 
                                ...
                                <div class="control-group">
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="unidades" id="unidades" class="input-small" type="text">
                                        <span class="help-inline"></span>
                                    </div>
                                </div> 
                                  <div class="control-group">
