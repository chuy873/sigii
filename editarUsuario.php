...
<div class="container">
	<div class="row">
		<div class="span7 offset2">
			<form id="edicionUsuario" class="form-horizontal well"
				action="control/admonUsuario.php" method="post">
				...
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="nombre" id="nombre" class="input-small" type="text"
								value="<?php echo $data["nombre"]?>" /> <input type="hidden"
								name="accion" value="editar"> <input type="hidden" id="id"
								name="idusuario" value="<?php echo $data["idusuarios"]?>"> <span
					...
					<div class="control-group">
						...
						<div class="controls">
							<input id="apellidos" name="apellidos" class="input-small"
								type="text" value="<?php echo $data["apellidos"]?>"> <span
								class="help-inline"></span>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input id="email" name="email" class="input-large" type="text"
								value="<?php echo $data["email"]?>"> <span class="help-inline"></span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="telefono">Tel&eacute;fono</label>
						<div class="controls">
							<input id="telefono" name="telefono" class="input-small"
								type="text" value="<?php echo $data["telefono"]?>"> <span
								class="help-inline"></span>
						</div>
					</div>
					<div class="control-group">
						...
						<div id="tipo" class="controls">
							<label class="radio inline"> <?php if( $data["tipo"]=="administrador"){?>
								<input id="admin" type="radio" value="administrador" name="tipo"
								checked="checked"> <?php } else {?> <input id="admin"
								type="radio" value="administrador" name="tipo"> <?php }?>
								Administrador
							</label> <label class="radio inline"> <?php if( $data["tipo"]=="revision"){?>
								<input id="revision" type="radio" value="revision" name="tipo"
								checked="checked"> <?php } else {?> <input id="revision"
								type="radio" value="revision" name="tipo"> <?php }?>
								Revisi&oacute;n
							</label> <label class="radio inline"> <?php if( $data["tipo"]=="captura"){?>
								<input id="captura" type="radio" value="captura" name="tipo"
								checked="checked"> <?php } else {?> <input id="captura"
								type="radio" value="captura" name="tipo"> <?php }?> Captura
							</label> <label class="radio inline"> <?php if( $data["tipo"]=="analisis"){?>
								<input id="analisis" type="radio" value="analisis" name="tipo"
								checked="checked"> <?php } else {?> <input id="analisis"
								type="radio" value="analisis" name="tipo"> <?php }?>
								An&aacute;lisis
							</label> <label class="radio inline"> <?php if( $data["tipo"]=="revision"){?>
								<input id="cliente" type="radio" value="cliente" name="tipo"
								checked="checked"> <?php } else {?> <input id="cliente"
								type="radio" value="cliente" name="tipo"> <?php }?> Cliente
				...
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="username" id="username" class="input-small"
								type="text" value="<?php echo $data["username"]?>"> <span
								class="help-inline"></span>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input name="password" id="password" class="input-medium"
								type="text" value="<?php echo $data["password"]?>"> <span
								class="help-inline"></span>
						</div>
					</div>
