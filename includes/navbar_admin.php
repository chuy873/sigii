          ...
          <div class="container">
            ...
            <div class="nav-collapse">
              <ul class="nav">
                ...
                <li class="dropdown">
                	<a href="#" data-toggle="dropdown" class="dropdown-toggle s" ><i class="icon-search icon-white"></i> PROYECTOS <b class="caret"></b></a>
                	<ul class="dropdown-menu">
                ...
                <li class="dropdown">
                	<a href="#" data-toggle="dropdown" class="dropdown-toggle s" ><i class="icon-search icon-white"></i> MODELOS <b class="caret"></b></a>
                	<ul class="dropdown-menu">
                		<li><a href="administrarModeloVertical.php"><i class="icon-resize-vertical icon-white"></i> ADMINISTRAR VERTICAL </a></li>
                		<li><a href="administrarModeloHorizontal.php"><i class="icon-resize-horizontal icon-white"></i> ADMINISTAR HORIZONTAL </a></li>
                ...
                <li class="dropdown">
                	<a href="#" data-toggle="dropdown" class="dropdown-toggle s"><i class="icon-th-list icon-white"></i> REPORTES <b class="caret"></b></a>
                	<ul class="dropdown-menu">
                 ...
                 <li><a href="consultar.php"><i class="icon-search icon-white s"></i> CONSULTAR </a></li>
              </ul>
