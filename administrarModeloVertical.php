<?php
/* Pagina Administrar Modelos verticales
...
$_SESSION['pageFrom']="administrarModeloVertical";
?>
<div class="row">
	<div class="span10 offset2">
		<form class="form-horizontal" action="#" method="post">
			<fieldset>
				<legend>
					<i class="icon-fullscreen"></i> Administrar modelos verticales
				</legend>
				<table class="table">
					<tr>
					...
					$data ="SELECT p.nombre AS proyecto, m.nombre AS modelo, p.promotor, p.segmento, ".
							"z.ciudad, z.subzona, md.precioPromedio, m.metrosCuadrados, m.idmodelo, p.tipo  ".
							"FROM proyecto p " .
							"INNER JOIN zona z " .
							"ON p.zona_idzona=z.idzona ".
							"INNER JOIN modelo m " .
							"ON m.proyecto_idproyecto = p.idproyecto ".
							"INNER JOIN modelodepartamento md " .
					...
					<tr>
						...
						<td>$<?php echo $data["precioPromedio"]?>
						</td>
				...
				<div class="form-actions">
					<a href="registrarModeloVertical.php" class="btn btn-inverse"><i
						class="icon-plus-sign icon-white"></i> Agregar modelo...</a> <a
