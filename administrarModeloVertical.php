	...
	<div class="row">
		<div class="span10 offset2">
		  <form class="form-horizontal" action="#" method="post">
		      <fieldset>
		        <legend><i class="icon-fullscreen"></i> Administrar modelos verticales</legend>
		        <table class="table">
		        	<tr>
					...
					while ($data = mysql_fetch_array($dataModelo, MYSQL_ASSOC)) {
					    	...
					    	<tr>							  		
							  		...
							  		<td>$<?php echo $data["precioPromedio"]?></td>								  		
		        ...
		        <div class="form-actions">
		          <a href="registrarModeloVertical.php" class="btn btn-inverse"><i class="icon-plus-sign icon-white"></i> Agregar modelo...</a>
