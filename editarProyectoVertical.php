<?php 
/* Pagina Editar proyecto vertical
...
$dataProyVertical="SELECT * FROM proyectodepartamento WHERE proyecto_idproyecto ='".$idProyecto."'";
$result2 = mysql_query( $dataProyVertical);
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab1">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input name="nombre" id="nombre" class="input-large"
											...
											type="hidden" name="tipo" value="vertical"> <input
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										<select class="span2" name='torres' id='torres'>
											<?php 
											$int = 0;
											while($int <=20){
												if($int==$data2["torres"]){
						...
						<div class="tab-pane" id="tab2">
							...
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label" for="lotificacion">Vista previa de
										torre</label>
									<div class="controls">
										...
										?>
										<img src="<?php echo $data6["path"]?>"> <input
											name="previaTorre" id="previaTorre" class="input-medium"
											type="file"
											onchange="comprueba_extension(this.value,'vistaprevia')"> <span
											class="help-inline"></span>
								...
								<div class="control-group">
									<label class="control-label" for="posicionamiento">Posicionamiento
										...
										<p class="help-block">Google Earth.</p>
										   <p>Instrucciones:</p>
										   	<p>1. Haz clic en <a  class="btn btn-primary" id="posicionar" onclick="init()"><i
											class="icon-globe icon-white"></i> Editar posici&oacute;n</a></p>
										   <p>2. Dir&iacute;gete a la ubicaci&oacute;n del proyecto.</p>
										   <p>3. Haz clic en   <a class="btn btn-info" id="btnPoli" onclick="dibujar();"><i class="icon-pencil"></i>Dibujar pol&iacute;gono</a></p>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="amenidadesDescripcion" class="input-xlarge"
											...
											placeholder="Descripción de las amenidades del proyecto...">
