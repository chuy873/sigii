...
<div class="row">
	<div class="span6 offset4">
		<form class="form-horizontal" action="#" method="post">
			<fieldset>
				<legend>
					<i class="icon-star-empty"></i>Administrar atributos
				</legend>
				<table class="table">
					<tr>
					...
					<tr>
						...
						<td><a href="#modalEdit" data-toggle="modal"
							class="openEditAtrib btn btn-primary"
							data-id="<?php echo $data["idatributos"]?>"
							data-nombre="<?php echo $data["nombre"]?>"><i
								class="icon-edit icon-white"></i> Editar</a>
						</td>
						<td><a href="#modalDelete" data-toggle="modal"
							class="openDeleteAtrib btn btn-danger"
							data-id="<?php echo $data["idatributos"]?>"><i
								class="icon-trash icon-white"></i> Eliminar</a>
						</td>
						<td><input type="hidden"
							value='<?php echo  $data["idatributos"]?>'
							name="idatributos_<?php echo $data["idatributos"]?>" /></td>
					</tr>
				...
				<div class="form-actions">
					<a href="#" class="confirm-add btn btn-inverse"><i
						class="icon-plus-sign icon-white"></i> Agregar atributos...</a> <a
						href="bienvenido.php" class="btn">Regresar</a>
				</div>
			</fieldset>
		</form>
	</div>
...
<div id="modalEditar" class="modal hide fade in">
	...
	<div class="modal-body">
		<label class="control-label" for="atributo">Nombre</label> <input
			type="text" class="input-medium" id="editaratributos"> <input
			type="hidden" id="idatributos">
...
<div id="modal4" class="modal hide fade in">
	...
	<div class="modal-body">
		<label class="control-label" for="atributos">Nombre</label> <input
			type="text" class="input-small" id="nombreatributos">
